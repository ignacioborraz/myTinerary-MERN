const Tineraries = require('../models/tineraries')

const tinerariesController = { //defino los metodos que necesita el controlador (utiliza una funcion asincrona (async/await))
...
/*     //el usuario "común" no deberia poder NI CARGAR, NI BORRAR, NI MODIFICAR UN OBJETO
    ...
    modifyCity: async (req,res) => { //request,response
        ...
        await Cities.findOneAndUpdate({_id:id},ciudad)
    }
 */
}

module.exports = tinerariesController //exporto los controladores
